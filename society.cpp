...
int main()
{
	...
	std::cin >> B;
	std::cout << B;*/
	Human A{ "Yan " ,"Redin " ,"23 " };
	std::cout << A.get_name() << A.get_surname() << A.get_age() << std::endl;
	system("pause");
	return 0;
}
Human::Human()
{
	this->name= this->surname = this->age = "None";
}
Human::Human(std::string name, std::string surname, std::string age)
{
	this->name = name;
...
Teacher::Teacher(int working_hours)
{
	this->working_hours = working_hours;
}
Teacher::Teacher(int working_hours, std::string name, std::string surname, std::string age) :Human(name, surname, age)
{
	this->working_hours = working_hours;
}
